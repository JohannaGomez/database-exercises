...
SELECT concat(e.first_name, ' ', e.last_name) AS 'Employee Name', d.dept_name AS 'Department Name', CONCAT(m.first_name, ' ' ,  m.last_name) AS 'Department manager'
FROM employees AS e
JOIN dept_emp as de
...
WHERE de.to_date = '9999-01-01' AND dm.to_date = '9999-01-01' AND e.last_name = 'Lortz' AND e.first_name = 'Huan'
ORDER BY d.dept_name;
